...
const Footer = () => {
    return (
        <footer className="bg-white dark:bg-zinc-900 border-t border-gray-200 dark:border-zinc-700 text-gray-800 dark:text-gray-200">
            <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                {/* Quick Links */}
                <div>
                    <h2 className="text-lg font-semibold text-red-600 mb-3">Quick Links</h2>
                    <ul className="space-y-2 text-sm">
                        <li><Link to="/" className="hover:text-red-600 transition">Home</Link></li>
                        <li><Link to="/all-articles" className="hover:text-red-600 transition">All Articles</Link></li>
                        <li><Link to="/add-article" className="hover:text-red-600 transition">Add Article</Link></li>
                        <li><Link to="/subscription" className="hover:text-red-600 transition">Subscription</Link></li>
                ...
                {/* Contact */}
                <div>
                    <h2 className="text-lg font-semibold text-red-600 mb-3">Contact Us</h2>
                    <ul className="space-y-2 text-sm">
            ...
            {/* Bottom Bar */}
            <div className="bg-red-600 text-white text-sm py-4 px-6">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-3">
                    <p>© {new Date().getFullYear()} K-Infonic. All rights reserved.</p>

                    <p className='text-xs text-red-100 opacity-30 font-serif italic'>A Product by K-Web Tec</p>
